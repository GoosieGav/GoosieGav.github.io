...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full min-h-screen overflow-hidden bg-black ${className}`}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white min-h-screen py-24 px-4">
        {/* Trust Badge */}
        {trustBadge && (
        ...
        <div className="text-center space-y-4 max-w-5xl mx-auto w-full">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-200 leading-tight">
              {headline.line1}
            </h1>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400 leading-tight">
              {headline.line2}
            </h1>
          </div>
          
          {/* Subtitle with Animation */}
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600 mt-6">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-orange-100/90 font-light leading-relaxed">
              {subtitle}
            </p>
          </div>
