...
const Hero: React.FC<HeroProps> = ({
  ...
  const badgeColorClasses = ["text-yellow-300", "text-orange-300", "text-amber-300"];
  ...
  return (
    <div className={cn("relative h-screen w-full overflow-hidden bg-black", className)}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 py-12 text-white">
        {trustBadge && (
          <div className="mb-8 animate-fade-in-down">
            <div className="flex items-center gap-3 rounded-full border border-orange-300/30 bg-orange-500/10 px-6 py-3 text-sm backdrop-blur-md">
              {trustBadge.icons && trustBadge.icons.length > 0 && (
                <div className="flex items-center gap-1 text-lg">
                  {trustBadge.icons.map((icon, index) => (
                    <span
                      key={index}
                      className={badgeColorClasses[Math.min(index, badgeColorClasses.length - 1)]}
                    >
                      {icon}
                    </span>
                  ))}
        ...
        <div className="mx-auto max-w-5xl space-y-6 text-center">
          <div className="space-y-2">
            <h1 className="bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-5xl font-bold text-transparent animate-fade-in-up animation-delay-200 md:text-7xl lg:text-8xl">
              {headline.line1}
            </h1>
            <h1 className="bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-5xl font-bold text-transparent animate-fade-in-up animation-delay-400 md:text-7xl lg:text-8xl">
              {headline.line2}
            </h1>
          </div>
